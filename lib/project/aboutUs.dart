      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: 20,),
            Text("© 2025 Darshan University" , style: TextStyle(fontFamily: 'Roboto'),),
            Text("All Right Reserverd - Privacy Policy" ,  style: TextStyle(fontFamily: 'Roboto')),
            Text("Made With 💖 in INDIA" , style: TextStyle(fontFamily: 'Roboto')),
            SizedBox(height: 20,),
          ],
        ),
      ),
